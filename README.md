...
El detalle completo de la problemática, el stack elegido, el alcance del MVP y el análisis de viabilidad está en el documento de la primera entrega: [`docs/Entrega1_Propuesta_y_Viabilidad.pdf`](./docs/Entrega1_Propuesta_y_Viabilidad.pdf).
...
├── README.md
├── docs/
│   └── Entrega1_Propuesta_y_Viabilidad.pdf
